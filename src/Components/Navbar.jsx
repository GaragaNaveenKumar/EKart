    ...
    <nav className="bg-white shadow-md fixed w-full top-0 left-0 z-50">
      <div className=" max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:block flex-grow mx-4">
            <div className="relative max-w-md mx-auto">
              <input
                type="text"
                placeholder="Search..."
                class="w-full h-9 border border-gray-400 rounded pl-10 pr-4 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
              />
          ...
          <div className="md:hidden pl-70 top-1.5 text-black">
                <button>
                <svg
                  className="h-6 w-6"
                  fill="none"
          ...
          <div className="hidden md:flex space-x-6 items-center ">
            ...
            <a href="#" nonce="text-gray-700 hover:text-blue-500">
              Services
            </a>
            <a href="#" className="text-gray-700 hover:text-blue-500">
              Contact
      ...
      <div
        id="menu"
        className="md:hidden hidden px-4 pb-4 bg-white space-y-3 shadow-md"
      >
